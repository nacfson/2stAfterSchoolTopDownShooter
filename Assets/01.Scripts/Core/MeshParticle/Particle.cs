...
public class Particle {
    ...
    private int QuadIndex => _quadIndex;

    public Particle(Vector3 quadPosition, Vector3 direction, MeshParticleSystem meshParticleSystem,  Vector3 quadSize, float rotation, int uvIndex, float moveSpeed, float slowDownFactor, bool isRotate)
    {
    ...
    {
        return _moveSpeed < 0.05f; // 이밑으로 떨어지면 정지
    }
}
